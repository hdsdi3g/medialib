...
class MediaSummaryTest {
    ...
    void testCreate_smallFile() {
        ...
        assertEquals("QuickTime / MOV, 00:00:50, 18 kbps", ms.format());
    }
    ...
    void testCreate_bigFile() {
        ...
        assertEquals("MOV, 00:00:50, 18 Mbps", ms.format());
    }
    ...
    void testCreate_programs_chapters() {
        ...
        assertEquals("null, 00:00:05, 9 programs, 1 chapter, 2 kbps", ms.format());
    ...
    void testGetAudioSummary() {
        ...
        s = FFprobeJAXB.load(
                """
                        ...
                        <ffprobe>
                            <streams>
                                <stream index="0" codec_name="pcm_FOOBAR" profile="profile" codec_type="type" sample_rate="48000" channels="8" channel_layout="layout" bit_rate="1000000" />
                            </streams>
                        </ffprobe>
                        """)
                .getStreams().stream().findFirst().orElseThrow();
                ...
                """
                        ...
                        <ffprobe>
                            <streams>
                                ...
                                <stream index="1" codec_name="prores" codec_long_name="Apple ProRes (iCodec Pro)" profile="Standard" codec_type="video" codec_time_base="1/50" codec_tag_string="apcn" codec_tag="0x6e637061" width="720" height="576" coded_width="720" coded_height="576" has_b_frames="0" sample_aspect_ratio="59:54" display_aspect_ratio="295:216" pix_fmt="yuv422p10le" level="-99" color_range="tv" color_space="smpte170m" color_transfer="bt709" color_primaries="bt470bg" field_order="progressive" refs="1" r_frame_rate="50/1" avg_frame_rate="50/1" time_base="1/50" start_pts="0" start_time="0.000000" duration_ts="2500" duration="50.000000" bit_rate="76328266" bits_per_raw_sample="10" nb_frames="2500">
                                    <disposition attached_pic="1" timed_thumbnails="0" still_image="0"/>
                                </stream>
                                <stream index="2" codec_name="prores" codec_long_name="Apple ProRes (iCodec Pro)" profile="Standard" codec_type="video" codec_time_base="1/50" codec_tag_string="apcn" codec_tag="0x6e637061" width="720" height="576" coded_width="720" coded_height="576" has_b_frames="0" sample_aspect_ratio="59:54" display_aspect_ratio="295:216" pix_fmt="yuv422p10le" level="-99" color_range="tv" color_space="smpte170m" color_transfer="bt709" color_primaries="bt470bg" field_order="progressive" refs="1" r_frame_rate="50/1" avg_frame_rate="50/1" time_base="1/50" start_pts="0" start_time="0.000000" duration_ts="2500" duration="50.000000" bit_rate="76328266" bits_per_raw_sample="10" nb_frames="2500">
                                    <disposition attached_pic="0" still_image="1" timed_thumbnails="0"/>
                                </stream>
                                <stream index="3" codec_name="prores" codec_long_name="Apple ProRes (iCodec Pro)" profile="Standard" codec_type="video" codec_time_base="1/50" codec_tag_string="apcn" codec_tag="0x6e637061" width="720" height="576" coded_width="720" coded_height="576" has_b_frames="0" sample_aspect_ratio="59:54" display_aspect_ratio="295:216" pix_fmt="yuv422p10le" level="-99" color_range="tv" color_space="smpte170m" color_transfer="bt709" color_primaries="bt470bg" field_order="progressive" refs="1" r_frame_rate="50/1" avg_frame_rate="50/1" time_base="1/50" start_pts="0" start_time="0.000000" duration_ts="2500" duration="50.000000" bit_rate="76328266" bits_per_raw_sample="10" nb_frames="2500">
                                    <disposition attached_pic="0" timed_thumbnails="1" still_image="0"/>
                                </stream>
                                <stream index="4" codec_name="pcm_s16le" codec_long_name="PCM signed 16-bit little-endian" codec_type="audio" codec_time_base="1/48000" codec_tag_string="sowt" codec_tag="0x74776f73" sample_fmt="s16" sample_rate="48000" channels="2" channel_layout="stereo" bits_per_sample="16" r_frame_rate="0/0" avg_frame_rate="0/0" time_base="1/48000" start_pts="0" start_time="0.000000" duration_ts="2400000" duration="50.000000" bit_rate="1536000" nb_frames="2400000">
                                </stream>
                                <stream index="5" codec_type="data" codec_tag_string="tmcd" codec_tag="0x64636d74" r_frame_rate="0/0" avg_frame_rate="50/1" time_base="1/50" start_pts="0" start_time="0.000000" duration_ts="2500" duration="50.000000" nb_frames="1">
                                    <tags>
                                        <tag key="creation_time" value="2019-11-03T15:08:36.000000Z"/>
                                        <tag key="language" value="eng"/>
                                        <tag key="handler_name" value="Time Code Media Handler"/>
                                ...
                                <stream index="6" codec_type="data" codec_tag_string="tmcd" codec_tag="0x64636d74" r_frame_rate="0/0" avg_frame_rate="50/1" time_base="1/50" start_pts="0" start_time="0.000000" duration_ts="2500" duration="50.000000" nb_frames="1">
                                    <disposition attached_pic="1"/>
                                    <tags>
                                        <tag key="creation_time" value="2019-11-03T15:08:36.000000Z"/>
                                        <tag key="language" value="eng"/>
                                        <tag key="handler_name" value="Time Code Media Handler"/>
                                        <tag key="timecode" value="40:00:00:00"/>
                                    </tags>
                                </stream>
                            </streams>
                        ...
                        """);
        assertThat(source.getXSDVersionReference()).isEqualTo("ffprobe810");
