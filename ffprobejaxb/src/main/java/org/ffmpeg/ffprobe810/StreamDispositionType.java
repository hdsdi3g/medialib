...
/**
 * &lt;p&gt;Java class for streamDispositionType complex type&lt;/p&gt;.
 * 
 ...
 *       &lt;attribute name="multilayer" use="required" type="{http://www.w3.org/2001/XMLSchema}int" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * }&lt;/pre&gt;
...
public class StreamDispositionType {
    ...
    @XmlAttribute(name = "non_diegetic", required = true)
    protected int nonDiegetic;
    @XmlAttribute(name = "captions", required = true)
    protected int captions;
    @XmlAttribute(name = "descriptions", required = true)
    ...
    @XmlAttribute(name = "still_image", required = true)
    protected int stillImage;
    @XmlAttribute(name = "multilayer", required = true)
    protected int multilayer;
    ...
    /**
     * Gets the value of the multilayer property.
     * 
     */
    ...
    /**
     * Sets the value of the multilayer property.
     * 
     */
    public void setMultilayer(int value) {
