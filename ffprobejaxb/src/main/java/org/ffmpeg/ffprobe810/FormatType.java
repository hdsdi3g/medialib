...
public class FormatType {
    ...
    @XmlAttribute(name = "nb_stream_groups", required = true)
    ...
    /**
     * Gets the value of the nbStreamGroups property.
     * 
     */
    public int getNbStreamGroups() {
        return nbStreamGroups;
    }

    /**
     * Sets the value of the nbStreamGroups property.
     * 
     */
    public void setNbStreamGroups(int value) {
        this.nbStreamGroups = value;
    }
