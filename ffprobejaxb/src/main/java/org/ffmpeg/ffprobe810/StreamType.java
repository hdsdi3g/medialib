 ...
 *       &lt;attribute name="mime_codec_string" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
...
public class StreamType {
    ...
    @XmlAttribute(name = "extradata_size")
    protected Integer extradataSize;
    @XmlAttribute(name = "extradata_hash")
    protected String extradataHash;
    @XmlAttribute(name = "mime_codec_string")
    protected String mimeCodecString;
    ...
    @XmlAttribute(name = "closed_captions")
    protected Boolean closedCaptions;
    @XmlAttribute(name = "film_grain")
    ...
    @XmlAttribute(name = "initial_padding")
    ...
    /**
     * Gets the value of the mimeCodecString property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getMimeCodecString() {
        return mimeCodecString;
    }

    /**
     * Sets the value of the mimeCodecString property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMimeCodecString(String value) {
        this.mimeCodecString = value;
    }
